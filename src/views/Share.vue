    ...
    <div class="mb-3">
      <ol class="list-group list-group-numbered">
        ...
        >
          ...
          <span @click="handleDelete(g.id)" class="badge bg-danger mx-2"
            ><i class="bi bi-x"></i
          ></span>
        </li>
      </ol>
  ...
  setup() {
    ...
    onMounted(() => {
      const q = query(
        ...
        where("gKullaniciAd", "==", kullanici.value.displayName)
      );
      ...
      onSnapshot(q, (querySnapshot) => {
        ...
        querySnapshot.forEach((doc) => {
          dizi.push({
            ...doc.data(),
            id: doc.id,
            tarih: moment(doc.data().tarih.toDate()).format("LLL"),
          });
        });
